...
SHARED_LIB void tmkgetinfo(TTmkConfigData *pConfD);
SHARED_LIB void tmkgetevd(TTmkEventData *pEvD);
SHARED_LIB void tmkdefevent(HANDLE hEvent, BOOL fEventSet);
SHARED_LIB int tmkgetmaxn();
SHARED_LIB int tmkconfig(int tmkNumber);
SHARED_LIB int tmkdone(int tmkNumber);
SHARED_LIB int tmkselect(int tmkNumber);
SHARED_LIB int tmkselected();
SHARED_LIB TMK_DATA tmkgetmode();
SHARED_LIB void tmksetcwbits(TMK_DATA tmkSetControl);
SHARED_LIB void tmkclrcwbits(TMK_DATA tmkClrControl);
SHARED_LIB TMK_DATA tmkgetcwbits();
SHARED_LIB int bcreset();
SHARED_LIB void bc_def_tldw(TMK_DATA wTLDW);
SHARED_LIB void bc_enable_di();
SHARED_LIB void bc_disable_di();
SHARED_LIB int bcdefirqmode(TMK_DATA bcIrqMode);
SHARED_LIB TMK_DATA bcgetirqmode();
SHARED_LIB TMK_DATA bcgetmaxbase();
SHARED_LIB int bcdefbase(TMK_DATA bcBasePC);
SHARED_LIB TMK_DATA bcgetbase();
SHARED_LIB void bcputw(TMK_DATA bcAddr, TMK_DATA bcData);
SHARED_LIB TMK_DATA bcgetw(TMK_DATA bcAddr);
SHARED_LIB DWORD bcgetansw(TMK_DATA bcCtrlCode);
SHARED_LIB void bcputblk(TMK_DATA bcAddr, void *pcBuffer, TMK_DATA cwLength);
SHARED_LIB void bcgetblk(TMK_DATA bcAddr, void *pcBuffer, TMK_DATA cwLength);
SHARED_LIB int bcdefbus(TMK_DATA bcBus);
SHARED_LIB TMK_DATA bcgetbus();
SHARED_LIB int bcstart(TMK_DATA bcBase, TMK_DATA bcCtrlCode);
SHARED_LIB int bcstartx(TMK_DATA bcBase, TMK_DATA bcCtrlCode);
SHARED_LIB int bcdeflink(TMK_DATA bcBase, TMK_DATA bcCtrlCode);
SHARED_LIB DWORD bcgetlink();
SHARED_LIB TMK_DATA bcstop();
SHARED_LIB DWORD bcgetstate();
SHARED_LIB int rtreset();
SHARED_LIB int rtdefirqmode(TMK_DATA rtIrqMode);
SHARED_LIB TMK_DATA rtgetirqmode();
SHARED_LIB int rtdefmode(TMK_DATA rtMode);
SHARED_LIB TMK_DATA rtgetmode();
SHARED_LIB TMK_DATA rtgetmaxpage();
SHARED_LIB int rtdefpage(TMK_DATA rtPage);
SHARED_LIB TMK_DATA rtgetpage();
SHARED_LIB int rtdefpagepc(TMK_DATA rtPagePC);
SHARED_LIB int rtdefpagebus(TMK_DATA rtPageBus);
SHARED_LIB TMK_DATA rtgetpagepc();
SHARED_LIB TMK_DATA rtgetpagebus();
SHARED_LIB int rtdefaddress(TMK_DATA rtAddress);
SHARED_LIB TMK_DATA rtgetaddress();
SHARED_LIB void rtdefsubaddr(TMK_DATA rtDir, TMK_DATA rtSubAddr);
SHARED_LIB TMK_DATA rtgetsubaddr();
SHARED_LIB void rtputw(TMK_DATA rtAddr, TMK_DATA rtData);
SHARED_LIB TMK_DATA rtgetw(TMK_DATA rtAddr);
SHARED_LIB void rtputblk(TMK_DATA rtAddr, void *pcBuffer, TMK_DATA cwLength);
SHARED_LIB void rtgetblk(TMK_DATA rtAddr, void *pcBuffer, TMK_DATA cwLength);
SHARED_LIB void rtsetanswbits(TMK_DATA rtSetControl);
SHARED_LIB void rtclranswbits(TMK_DATA rtClrControl);
SHARED_LIB TMK_DATA rtgetanswbits();
SHARED_LIB void rtgetflags(void *pcBuffer, TMK_DATA rtDir, TMK_DATA rtFlagMin, TMK_DATA rtFlagMax);
SHARED_LIB void rtputflags(void *pcBuffer, TMK_DATA rtDir, TMK_DATA rtFlagMin, TMK_DATA rtFlagMax);
SHARED_LIB void rtsetflag();
SHARED_LIB void rtclrflag();
SHARED_LIB TMK_DATA rtgetflag(TMK_DATA rtDir, TMK_DATA rtSubAddr);
SHARED_LIB TMK_DATA rtgetstate();
SHARED_LIB TMK_DATA rtbusy();
SHARED_LIB void rtlock(TMK_DATA rtDir, TMK_DATA rtSubAddr);
SHARED_LIB void rtunlock();
SHARED_LIB TMK_DATA rtgetcmddata(TMK_DATA rtBusCommand);
SHARED_LIB void rtputcmddata(TMK_DATA rtBusCommand, TMK_DATA rtData);
SHARED_LIB int mtreset();
SHARED_LIB TMK_DATA mtgetsw();
...
SHARED_LIB TMK_DATA rtenable(TMK_DATA rtEnable);

SHARED_LIB int mrtgetmaxn();
SHARED_LIB DWORD mrtconfig(int tmkNumber);
SHARED_LIB int mrtselected();
SHARED_LIB TMK_DATA mrtgetstate();
SHARED_LIB void mrtdefbrcsubaddr0();
SHARED_LIB int mrtreset();

SHARED_LIB TMK_DATA tmktimer(TMK_DATA tmkTimerCtrl);
SHARED_LIB DWORD tmkgettimer();
SHARED_LIB TMK_DATA tmkgettimerl();
SHARED_LIB DWORD bcgetmsgtime();
#define mtgetmsgtime bcgetmsgtime
SHARED_LIB DWORD rtgetmsgtime();
SHARED_LIB TMK_DATA tmkgethwver();

SHARED_LIB DWORD tmkgetevtime();
SHARED_LIB TMK_DATA tmkswtimer(TMK_DATA tmkTimerCtrl);
SHARED_LIB DWORD tmkgetswtimer();

SHARED_LIB TMK_DATA tmktimeout(TMK_DATA tmkTimeOut);
SHARED_LIB 
SHARED_LIB int mrtdefbrcpage(TMK_DATA mrtBrcPage);
SHARED_LIB TMK_DATA mrtgetbrcpage();
